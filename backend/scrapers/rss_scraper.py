...
- Only scrapes articles from last 96 hours (4 days, configurable via env var)
- Prevents old articles from RSS feeds (which often contain 7-14 days of content)
- Configurable window: SCRAPE_TIME_WINDOW_HOURS (default: 96)
"""
...
class RSScraper(BaseScraper):
    ...
    def scrape(self, source_url):
        ...
        try:
            ...
            # Configurable via environment variable (default: 96 hours = 4 days)
